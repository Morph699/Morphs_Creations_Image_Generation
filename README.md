...
Automatically generates matching .txt log files (AI_Gen_12345678.txt) alongside generated PNGs containing timestamp, prompt, enhanced prompt, seed, model engine, aspect ratio, quality tier, and API target URL.
